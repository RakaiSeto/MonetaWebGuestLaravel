...
<div id="header" class="app-header">
    ...
    <div class="brand">
        ...
        <a href="#" class="brand-logo">
            <h4 style="margin-bottom: 0rem">{{$storeName}}</h4>
        </a>
    </div>
    <!-- END brand -->
        ...
        <div class="menu-item dropdown">
            <a href="#" data-bs-toggle="dropdown" data-display="static" class="menu-link">
                <div class="menu-img online">
                    <img src="https://static.vecteezy.com/system/resources/thumbnails/009/292/244/small/default-avatar-icon-of-social-media-user-vector.jpg" alt="" class="ms-100 mh-100 rounded-circle" />
                </div>
            ...
            <div class="dropdown-menu dropdown-menu-end me-lg-3">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{ url('logout')}}">Log Out <i class="fa fa-toggle-off fa-fw ms-auto text-body text-opacity-50"></i></a>
            </div>
        </div>
    </div>
    <!-- END menu -->
